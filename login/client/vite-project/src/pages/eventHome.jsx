...
Event branding.</span>
          ...
          <div className="button-container">
            <button onClick={() => navigate('/eventDetail')} className="heshanibtn btn-primary">
              Event Details
            </button>
            <button onClick={() => navigate('/addNewEvent')} className="heshanibtn btn-primary">
             Add Event
            </button>
            <button onClick={() => navigate('/eventAbout')} className="heshanibtn btn-primary">
              About Us
            </button>
            </div> 
      ...
      <hr />
      <footer className="heshafooter25">
      <div className="heshanicard25">
        <div className="container">
          <div className="contact-section">
            <h4>Contact Us</h4>
            <p>Phone: 123-456-7890</p>
            <p>Email: info@foodstore.com</p>
        <p className="heshanitext-center">All rights reserved &copy;</p>
        </div></div> </div>
      </footer>
    </div>
    </div> </div></div>
