...
const { comparePassword, hashPassword } = require('../helpers/employee');
...
const createEmployee = async (req, res) => {
  try {
    ...
    // Check if a profile photo was uploaded and store its filename in the database
    if (req.file) {
      newEmployee.profilePhoto = req.file.filename;
    }
